...
-	The design aims to be suitable for both a commercial or domestic enquiry.  The trust elements are common to both prospects and a high level list of services are shown at the bottom of the home page.  If the site was to be launched to the world then I expect there would be another layer of pages to be more specific about each service area.
